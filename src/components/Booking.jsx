    ...
    <div className="mt-[160px] mx-4 md:mt-[160px] relative">
      <div className="bg-white rounded-md max-w-6xl w-full mx-auto">
        <form className="flex flex-col md:flex-row">
          ...
          <p className="text-center">Destination From</p>
            <div className="flex flex-row">
              <select
                className="outline-none px-2 py-2 w-full text-center"
                name="from"
                required
          ...
          <div className="py-1.5 px-2.5 flex-1 border-r-2">
            <p className="text-center">Destination To</p>
            <div className="flex flex-row">
          ...
          <div className="py-1.5 px-2.5 flex-1 border-r-2">
            <p className="text-center">Journey Date</p>
            <input
              type="date"
              className="outline-none px-2 py-2 w-full date text-center"
              name="date"
              required
              onChange={(e) => handleChange(e)}
            />
          ...
          <div className="py-1.5 px-2.5 flex-1 border-r-2">
            ...
            <div className="flex flex-row">
              <select
                className="outline-none px-2 py-2 w-full ext-center"
                name="guests"
                required
                onChange={(e) => handleChange(e)}
              >
